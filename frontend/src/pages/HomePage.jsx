    ...
    <div className="home-page-container">
      ...
      <main className="home-hero">
        <div className="hero-content">
          ...
          <p className="hero-description">
            A LogiRed centraliza sua operação de transporte, da cotação à auditoria, transformando dados em economia real.
          </p>
        ...
        <div className="hero-dashboard-wrapper">
          ...
          <RouterLink to="/preview" className="dashboard-cta">
      ...
      <AnimatedSection id="quemsomos" className="section-dark">
        ...
        <p className="section-description">
          A LogiRed foi fundada por especialistas em logística e tecnologia com um único objetivo: simplificar o complexo. 
          Entendemos os desafios do transporte no Brasil e criamos uma plataforma robusta, intuitiva e pronta para escalar com o seu sucesso.
        </p>
        <div className="testimonials">
            <div className="testimonial-card">
                <p>"Desde que adotamos a LogiRed, nossa economia com fretes aumentou em 18%. A visibilidade que ganhamos é incomparável."</p>
                <div className="testimonial-author">
                    <FaUserTie />
                    <span><strong>João Silva</strong>, Diretor de Logística na "Distribuidora Veloz"</span>
                </div>
            </div>
        </div>
      </AnimatedSection>
      ...
      <footer className="home-footer">
        <p>© 2025 LogiRed Entregas Expressas. Todos os direitos reservados.</p>
      </footer>
    </div>
  );
}
