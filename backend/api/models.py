...
class Entrega(models.Model):
    ...
    altura_m = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    largura_m = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    comprimento_m = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
