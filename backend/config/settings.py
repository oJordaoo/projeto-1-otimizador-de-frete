...
# Configurações do CORS (para permitir a comunicação com o frontend)
CORS_ALLOW_ALL_ORIGINS = True # Para desenvolvimento. Em produção, seja mais restritivo.
